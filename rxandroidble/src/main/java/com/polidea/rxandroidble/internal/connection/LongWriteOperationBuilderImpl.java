...
public final class LongWriteOperationBuilderImpl implements RxBleConnection.LongWriteOperationBuilder {
    ...
    private final Provider<RxBleRadioOperationCharacteristicLongWrite> longWriteProvider;
    ...
    LongWriteOperationBuilderImpl(
            ...
            @Named("current-mtu") Callable<Integer> defaultMaxBatchSizeCallable,
            RxBleConnection rxBleConnection,
            Provider<RxBleRadioOperationCharacteristicLongWrite> longWriteProvider
    ) {
        this.rxBleRadio = rxBleRadio;
        this.maxBatchSizeCallable = defaultMaxBatchSizeCallable;
        this.rxBleConnection = rxBleConnection;
        this.longWriteProvider = longWriteProvider;
    }
